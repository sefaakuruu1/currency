const api_key = "af790f59f0121179cec1ea82";
const url = "https://v6.exchangerate-api.com/v6/" + api_key;

// elements
//tüm verileri buu şekilde aldık.
...
fetch(url + "/codes")
    ...
    .then(data => {
        ...
        for(let item of items) {
            //liste olusturması için options actık 
            //1.indexteki degerı gorunur yaptık
...
//butonun dinlenmesi ile hesaplama yapılacak işlemler başlanır
